        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link to="/courses" className="btn-premium bg-secondary text-white dark:text-neutral-dark hover:bg-earth shadow-xl shadow-secondary/20 flex items-center gap-2">
