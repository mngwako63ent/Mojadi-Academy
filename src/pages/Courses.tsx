  ...
  return (
    <div className="pt-32 pb-32 space-y-12 max-w-7xl mx-auto px-6">
      <div className="space-y-4">
        ...
        <p className="text-primary/60 dark:text-white/60 max-w-2xl">
      ...
      {filteredCourses.length === 0 && (
        <div className="text-center py-20 space-y-4">
          ...
          <p className="text-primary/60 dark:text-white/60">Try adjusting your search or filters to find what you're looking for.</p>
          <button 
